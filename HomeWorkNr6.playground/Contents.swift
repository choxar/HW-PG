...
let andSecondNumber: Int = 5

calculateResult(firstNumber: 4, andSecondNumber: 5, withCalculationType: CalculationType.addition)
calculateResult(firstNumber: 4, andSecondNumber: 5, withCalculationType: CalculationType.subtraction)
calculateResult(firstNumber: 4, andSecondNumber: 5, withCalculationType: CalculationType.multiplication)
calculateResult(firstNumber: 4, andSecondNumber: 5, withCalculationType: CalculationType.division)
